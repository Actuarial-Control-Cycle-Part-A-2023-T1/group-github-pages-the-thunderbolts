...
for (j in unique(nb_params_lower[, Region])){
  ...
  sim_values_low_freq<- matrix(sapply(lower_rand_freq, qnbinom, size = nb_params_lower[Region == j, Size], mu = nb_params_lower[Region == j, Mu]),
                             nrow = no_sims)
...
for (j in unique(nb_params_mid[, Region])){
  ...
  sim_values_middle_freq<- matrix(sapply(middle_rand_freq, qnbinom, size = nb_params_mid[Region == j, Size], mu = nb_params_mid[Region == j, Mu]),
                               nrow = no_sims)
...
sim_values_freak_freq<- matrix(sapply(freak_rand_freq, qnbinom, size = nb_params_freak[, Size], mu = nb_params_freak[, Mu]),
                               nrow = no_sims)
